"""
Django settings for embers project.
...
SECRET_KEY = 'v5)7@_0o%x@-)6#37%kqi^51cb@r19499k-_#ey1*zpac=$lmz'
...
WSGI_APPLICATION = 'embers.wsgi.application'
